...
def __main__():
    ...
    for i in to_test:
        ...
        if doComparisonToNoTIP:
            currfile_WT = 'search1/20210529_new_recalibration-txset{:02d}.txt'.format(i)
            currfile_TIP = 'search1/20210529_new_recalibration_parameter_sweep_list-WTTIP_TIP-txset{:02d}-rho1-5_psi0-02_I10x100_enhance_Initial.txt'.format(i)
            currfigname = 'search1/20210529_new_recalibration_parameter_sweep_list-WTTIP_TIP-txset{:02d}-rho1-5_psi0-02_I10x100_enhance_Initial_WTonlytx_vs_TIPtransmission.png'.format(i)
        ...
        if plot_WTWT_vs_DualWT_result:
            WTWTfile = 'search1/20210529_new_recalibration-txset{:02d}.txt'.format(i)
            DualWTfile = 'search1/20210529_new_recalibration_parameter_sweep_list-WTTIP_WT-txset{:02d}-rho1-5_psi0-02_I10x100_enhance_Initial.txt'.format(i)
            figureName = 'search1/20210529_new_recalibration_parameter_sweep_list-WTTIP_WT-txset{:02d}-rho1-5_psi0-02_I10x100_enhance_Initial_WT_transmission_TIPvsNoTIP.png'.format(i)
