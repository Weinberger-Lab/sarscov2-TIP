...
def simulate_dual_inf(params, t0, tf):
    ...
    first_Y0 = [T10, 0, VT0*psi, 0, VT0 * rho, 0, 0, 0, T20, 0, 0, 0, 0, 0, 0, 0]
...
def __main__():
    visualize_impact_of_TIP_prophylaxis_timecourses_v3_Ind6Only_transmission_dynamics(figurebasename='20210603_rho1-5_psi0-02_individualVLs_fracTIP0-5_ind6',
                                                                              rho=1.5, psi=0.02, xi=1, delta_TIP=1, fractionTIP=0.5)
